...
template <class Vec>
void maptoVehicle(Vec& c_x, Vec& c_y, const Vec& m_x, const Vec& m_y, 
                   double psi, double tx, double ty)
{
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          */
          ...
          maptoVehicle(next_x_vals, next_y_vals, ptsx, ptsy, psi, px, py);


          Eigen::VectorXd coeffs;
          {       
            Eigen::VectorXd x (next_x_vals.size());
            Eigen::VectorXd y (next_y_vals.size());
          ...
          double steer_value= -mpc_results[0] / 0.436332;
